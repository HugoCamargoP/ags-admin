...
<script type="text/javascript" src="${ContextPath}/r/js${DeployContext}/WARDSrvc.js" charset="utf-8"></script>


<%-- Controlles Angular --%>
<script type="text/javascript" src="${ContextPath}/r/js${DeployContext}/WARDCtrl.js" charset="utf-8"></script>
<%-- Controlles Angular --%>