...
<script data-require="angular-sanitize@*" data-semver="1.4.3" src="${ContextPath}/r/js/angular-sanitize.js"></script>    
...
<script type="text/javascript" src="${ContextPath}/r/js/jquery.min.js"></script>
...
<script type="text/javascript" src="${ContextPath}/r/js/classie.js"></script>
<script type="text/javascript" src="${ContextPath}/r/js/uisearch.js"></script>
...
<script type="text/javascript" src="${ContextPath}/r/js/ui-bootstrap.js"></script>
<script type="text/javascript" src="${ContextPath}/r/js/jquery-ui.js"></script>
...
<script type="text/javascript" src="${ContextPath}/r/js${DeployContext}/Srvc.js" charset="utf-8"></script>
